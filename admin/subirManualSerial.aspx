<%@ Page Language="vb" AutoEventWireup="false" Codebehind="subirManualSerial.aspx.vb" Inherits="BPColSysOP.subirManualSerial" %>
...
<HTML>
	...
	<body class="cuerpo" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<font face="Arial, Helvetica, sans-serif" color="black" size="4"><b>Ingreso Serial para 
					Devoluciones</b></font>&nbsp;
			<hr>
			<table class="tabla" width="90%">
				<tr>
					<td><asp:hyperlink id="hlRegresar" runat="server" NavigateUrl="javascript:history.back();" Font-Bold="True">Regresar</asp:hyperlink><br>
						<br>
					</td>
				</tr>
				<tr>
