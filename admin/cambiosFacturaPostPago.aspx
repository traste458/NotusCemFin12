<%@ Page Language="vb" AutoEventWireup="false" Codebehind="cambiosFacturaPostPago.aspx.vb" Inherits="BPColSysOP.cambiarFacturaPostPago" %>
...
<HTML>
	<HEAD>
		...
		<script language="javascript" type="text/javascript">
		  function validacion(){
		   if(document.Form1.txtSerial.value==0 && document.Form1.txtSim.value.replace(" ","")==0 && document.Form1.txtFactura.value==0 && document.Form1.txtMin.value==0){
		     alert("Digite el Serial, la Sim, el Min o la Factura asociada a la Venta, Por Favor");
		     document.Form1.txtSerial.focus();
		     return(false);
		   }
		   
		   var seleccionado = false;
		   for(var i=1;i<document.getElementsByName("rblTipoCambio").length;i++){
		     if(document.getElementsByName("rblTipoCambio").item(i).checked==true){
		       seleccionado = true;
		     }
		   }
		   if(seleccionado==false){
		      alert("Escoja el Tipo de Cambio, Por Favor");
		      document.getElementById("rblTipoCambio").focus();
		      return(false);
		    }
		  }
		</script>
	...
	<body class="cuerpo">
		<font face="Arial, Helvetica, sans-serif" color="black" size="4"><b>Cambios en Facturas 
				Postpago</b></font>&nbsp;
		<hr>
