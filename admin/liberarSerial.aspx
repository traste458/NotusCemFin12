<%@ Page Language="vb" AutoEventWireup="false" Codebehind="liberarSerial.aspx.vb" Inherits="BPColSysOP.liberarSerial" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>liberarSerial</title>
		...
		<form id="Form1" onsubmit="return validacion();" method="post" runat="server">
			...
			<table class="tabla" id="tablaInicial">
				<tr>
					...
					<td class="celdaNormal" width="200"><asp:textbox id="txtSerial" runat="server" CssClass="textbox" MaxLength="20"></asp:textbox></td>
				</tr>
				<TR>
				...
				<tr>
					<td colSpan="2"><br>
						<br>
						<asp:button id="btnContinuar" runat="server" Text="Continuar" CssClass="boton"></asp:button></td>
				</tr>
			</table>
		</form>
	</body>
