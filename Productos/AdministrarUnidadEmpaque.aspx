<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdministrarUnidadEmpaque.aspx.vb"
    Inherits="BPColSysOP.AdministrarUnidadEmpaque" %>
                        ...
                        <asp:Panel ID="pnlRegistro" runat="server"  Style="display: none; width: 500px;
                            ...
                            <table class="tabla" border="1" align="center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtDescripcion" runat="server" MaxLength="20" Width="200px"></asp:TextBox>
                                        <div style="display: block;">
                                            <asp:RequiredFieldValidator ID="rfvDescripcion" runat="server" 
                                                ControlToValidate="txtDescripcion" Display="Dynamic" 
                                                ErrorMessage="Digite la descripción de la Unidad de Empaque, por favor" 
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        ...
                                        <asp:HiddenField ID="hIdTipoUnidad" runat="server" />
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
                        <asp:Panel ID="pnlBusqueda" runat="server"  Style="display: none; width: 500px;
                            ...
                            <table class="tabla" border="1" align="center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtBuscarDescripcion" runat="server" Width="200px" MaxLength="20"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field">
            ...
            <table class="tabla">
                <tr>
                    <th style="text-align: center">
                        LISTADO DE UNIDADES DE EMPAQUE REGISTRADAS
                    </th>
                </tr>
                <tr>
                    <td>
                        <asp:GridView ID="gvListado" runat="server" EmptyDataText="<blockquote>No se encontraron registros</blockquote>"
                            ...
                            <Columns>
                                <asp:BoundField DataField="idTipoUnidad" HeaderText="ID" ItemStyle-HorizontalAlign="Center" />
                                ...
                                <asp:TemplateField HeaderText="OPCIÓN" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ibActualizar" ImageUrl="~/images/Edit-32.png" ToolTip="Actualizar"
                                            CommandName="actualizar" CommandArgument='<%# Bind("idTipoUnidad") %>' runat="server" />
                                    </ItemTemplate>
