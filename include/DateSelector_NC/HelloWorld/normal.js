...
var gcCalBG="#C76114";  // the background color of the outer calendar panel.
var guCalBG=null;   //  the background image url for the inner table.
var gcCalFrame="#8B4513";   // the background color of the inner table, showing as a frame.
...
var gcCellBG="#FFFCCF"; // default background color of the cells. Use "" for transparent!!!
...
var gcSatBG="#FFCC11";  // Saturday background color
var gcSun="black";  // Sunday font color
var gcSunBG="#FEF1B5";  // Sunday background color

var gcOtherDay="#FF8C00";    // the font color of days in other months; It's of no use when giShowOther is set to hide.
...
var gcFGToday="#FF8C00";    // the font color for today
var gcBGToday="FFB90F";  // the background color for today
