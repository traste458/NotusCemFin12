...
var gsOutOfRange="Lo sentimos, no puede escoger una fecha anterior a la fecha inicial";  // out-of-date-range error message. If set to "", no alerts will popup on such error.
