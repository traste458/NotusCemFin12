<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ActualizarFacturaserviciomensajeria.aspx.vb"
    Inherits="BPColSysOP.ActualizarFacturaserviciomensajeria" %>
...
<head runat="server">
    <title>Actualizar Factura Servicio Mensajería</title>
    ...
    <div>
        ...
        <div style="float: left; margin-right: 20px; margin-bottom: 20px; margin-top: 15px;
            ...
            <dx:ASPxCallbackPanel ID="cpRegistro" runat="server" ClientInstanceName="cpRegistro"
                ...
                <PanelCollection>
                    <dx:PanelContent>
                        <dx:ASPxRoundPanel ID="rpCierreCiclo" runat="server" HeaderText="Actualizar Factura Servicio Mensajería"
                            Width="60%">
                            <PanelCollection>
                                <dx:PanelContent>
