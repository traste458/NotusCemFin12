<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReporteDetalladoServiciosSiembra.aspx.vb" Inherits="BPColSysOP.ReporteDetalladoServiciosSiembra" %>
...
<head runat="server">
    <title>.:: Reporte Detallado de Servicios SIEMBRA ::.</title>
                            ...
                            <dx:PanelContent>
                                <table cellpadding="1">
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxComboBox ID="cmbGerencia" runat="server" IncrementalFilteringMode="Contains"
                                                Width="250px" ClientInstanceName="cmbGerencia" 
                                        ...
                                        <td>
                                            <dx:ASPxComboBox ID="cmbCoordinador" runat="server" IncrementalFilteringMode="Contains"
                                                Width="250px" ClientInstanceName="cmbCoordinador"
                                                DropDownStyle="DropDownList">
                                            </dx:ASPxComboBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxComboBox ID="cmbEstado" runat="server" IncrementalFilteringMode="Contains"
                                                Width="150px" ValueField="idEstado" ClientInstanceName="cmbEstado" 
                                                DropDownStyle="DropDownList">
                                            </dx:ASPxComboBox>
                                        </td>
                                    </tr>
                                            ...
                                            <dx:ASPxComboBox ID="cbFormatoExportar" runat="server" 
                                                ...
                                                <Items>
                                                    <dx:ListEditItem ImageUrl="../images/xlsx_win.png" Text="Exportar a XLSX" 
                                                        Value="xlsx" />
                                                    <dx:ListEditItem ImageUrl="../images/excel.gif" Selected="True" 
            ...
            <PanelCollection>
                <dx:PanelContent>
                    <dx:ASPxGridView ID="gvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="fechaPrestamo" Caption="Fecha Préstamo" ShowInCustomizationForm="True"
                                VisibleIndex="0">
                                <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy">
                                </PropertiesTextEdit>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="ejecutivo" Caption="Ejecutivo Corporativo"
                                ShowInCustomizationForm="True" VisibleIndex="1">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="region" Caption="Región" ShowInCustomizationForm="True"
                                VisibleIndex="2">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="nit" Caption="NIT"
                                ShowInCustomizationForm="True" VisibleIndex="3">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="nombreCliente" Caption="Nombre Cliente"
                                ShowInCustomizationForm="True" VisibleIndex="5">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="serial" Caption="IMEI/ICCID" ShowInCustomizationForm="True"
                                VisibleIndex="6">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="referencia" Caption="Referencia" ShowInCustomizationForm="True"
                                VisibleIndex="7">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="fechaDevolucion" Caption="Fecha Devolución" ShowInCustomizationForm="True"
                                VisibleIndex="8">
                                <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy">
                                </PropertiesTextEdit>
                            </dx:GridViewDataTextColumn>
