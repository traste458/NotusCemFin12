...
Partial Public Class CreacionRutasRecoleccionServicio
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            With epNotificacion
                .setTitle("Creación de Rutas Recolección")
...
#Region "Métodos"
    ...
    Private Sub GenerarRutas()
        ...
        Try
            ...
            For Each responsable As DataRow In dtResponsables.Rows
                ...
                objRutaServicio.TipoRuta = Enumerados.TipoRutaServicioMensajeria.RecoleccionCliente
    ...
    Private Function CargarPool() As DataTable
        ...
        Try
            ...
            dtPool = objGenerarPoolRutas.GenerarPoolRecoleccion()
        Catch ex As Exception
