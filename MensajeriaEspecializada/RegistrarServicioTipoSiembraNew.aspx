<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RegistrarServicioTipoSiembraNew.aspx.vb"
    Inherits="BPColSysOP.RegistrarServicioTipoSiembraNew" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function LimpiaFormulario() {
            if (confirm("¿Realmente desea limpiar los campos del formulario?")) {
                ...
                callbackRegistro.PerformCallback('limpiarFormulario');
            }
        }
                        ...
                        <PanelCollection>
                            <dx:PanelContent>
                                <dx:ASPxFormLayout ID="flRegistro" runat="server" ColCount="2">
                                    <Items>
                                        <dx:LayoutItem Caption="Seleccione un Archivo:" ColSpan="2" RequiredMarkDisplayMode="Required">
                                                ...
                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer23" runat="server">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div style="margin-top: 5px; margin-bottom: 5px;">
                                                                    <dx:ASPxButton ID="ButtonVerEjemplo" AutoPostBack="false" runat="server" ClientInstanceName="ButtonVerEjemplo" CssClass="submit"
                                                                        Text="" Theme="Glass" Width="20px" Height="10px" ImagePosition="Bottom" ToolTip="Descargar archivo de ejemplo ">
                                                                        <Image Url="~/images/Excel-48x48.png" Height="20px" Width="20px"></Image>
                                                                    </dx:ASPxButton>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div style="margin-top: 5px; margin-bottom: 5px;">
                                                                    <dx:ASPxButton ID="btnUpload" AutoPostBack="false" runat="server" ValidationGroup="validacion" ClientInstanceName="btnUpload" CssClass="submit"
                                                                        Text="" Theme="SoftOrange" Width="30px" Height="10px">
                                                                ...
                                                                <div style="margin-left: 5px; margin-bottom: 5px; margin-top: 5px;">
                                                                    <dx:ASPxLabel ID="AspTexMensajeArchivo" runat="server" Text="Procesar Archivo."
                                                                        CssClass="comentario" Width="230px" Font-Size="XX-Small" Font-Bold="False" Font-Italic="True"
                                                    ...
                                                    <div id="divpnlErrores">
                                                        <dx:ASPxRoundPanel ID="rpLogErrores" runat="server" Visible="false" Width="90%" ScrollBars="Auto"
                                                            ...
                                                            <PanelCollection>
                                                                <dx:PanelContent>
                                                                    <dx:ASPxButton ID="btnExportar" runat="server" Visible="false" Text="Exportar Errores a Excel">
                                                                    </dx:ASPxButton>
                                                                    ...
                                                                    <dx:ASPxGridView ID="gvErrores" runat="server" AutoGenerateColumns="False" Width="100%"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <dx:GridViewDataTextColumn Caption="Valor" FieldName="Radicado" ShowInCustomizationForm="False"
                                                                                VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                        ...
                                        <dx:LayoutItem Caption="Fecha de Solicitud:" RequiredMarkDisplayMode="Required">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer1" runat="server">
                                                    <dx:ASPxDateEdit ID="dateFechaSolicitud" runat="server" Width="100px" ClientInstanceName="dateFechaSolicitud" ClientEnabled="False">
                                                    </dx:ASPxDateEdit>
                                                </dx:LayoutItemNestedControlContainer>
                                            </LayoutItemNestedControlCollection>
                                        </dx:LayoutItem>
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer2" runat="server">
                                                    <dx:ASPxComboBox ID="cmbCiudadEntrega" runat="server" DropDownStyle="DropDownList"
                                                        ValueField="idCiudad" ValueType="System.Int32" TextFormatString="{0} ({1})"
                                        ...
                                        <dx:LayoutItem Caption="Dirección:">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer123" runat="server">
                                                    <dx:ASPxTextBox ID="textDireccion" runat="server" MaxLength="200">
                                                        <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip" ValidationGroup="vgRegistrar">
                                                            <RequiredField IsRequired="True" ErrorText="La direccion es requerida"></RequiredField>
                                                        </ValidationSettings>
                                                    </dx:ASPxTextBox>
                                                </dx:LayoutItemNestedControlContainer>
                                            </LayoutItemNestedControlCollection>
                                        ...
                                        <dx:PanelContent>
                                            ...
                                            <br />
                                                ...
                                                <dx:ASPxGridView ID="gvCombinacionEquipos" runat="server" AutoGenerateColumns="False"
                                                    ClientInstanceName="gvEquipos" KeyFieldName="_msisdn" Width="100%">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Plan" ShowInCustomizationForm="True" VisibleIndex="1"
                                                            FieldName="_nombrePlan">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Paquete" ShowInCustomizationForm="True" VisibleIndex="1"
                                                            FieldName="_Paquete">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Material" FieldName="_material" ShowInCustomizationForm="True"
                                                            VisibleIndex="3">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Tipo SIM" ShowInCustomizationForm="True" VisibleIndex="5"
                                                            FieldName="_tipoSim">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Descripción" FieldName="_Descripcionmaterial" ShowInCustomizationForm="True"
                                                            VisibleIndex="4">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataDateColumn Caption="Fecha Devolución" FieldName="_fechaDevolucion"
