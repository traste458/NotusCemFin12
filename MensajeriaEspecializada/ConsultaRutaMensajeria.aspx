<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ConsultaRutaMensajeria.aspx.vb"
    Inherits="BPColSysOP.ConsultaRutaMensajeria" %>
...
<body class="cuerpo2">
    ...
    <table class="tablaGris" cellpadding="1" style="width: 700px;">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtIdRuta" runat="server" MaxLength="15" ValidationGroup="buscarRuta"></asp:TextBox>
                <div>
        ...
        <tr>
            ...
            <td colspan="3" valign="bottom">
                ...
                <eo:CallbackPanel ID="cpFiltroMoto" runat="server" UpdateMode="Self" ClientSideAfterUpdate="CallbackAfterUpdateHandler"
                    Style="display: inline; padding: 0px 0px 0px 0px; vertical-align: middle" GroupName="generalFiltro">
