<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ActualizarMarcacionTipoSIMserialesCEM.aspx.vb"
    Inherits="BPColSysOP.ActualizarMarcacionTipoSIMserialesCEM" %>
        ...
        <div>
            ...
            <div style="float: left; margin-right: 20px; margin-bottom: 20px; margin-top: 15px; width: 100%;">
                ...
                LoadingPanel.Hide(); }"></ClientSideEvents>
                    <PanelCollection>
                        <dx:PanelContent>
                            <dx:ASPxRoundPanel ID="rpCambioTipoSim" runat="server" HeaderText="Actualizar Marcación Tipo Sims serial CEM"
                                Width="60%">
                                <PanelCollection>
                                    <dx:PanelContent>
