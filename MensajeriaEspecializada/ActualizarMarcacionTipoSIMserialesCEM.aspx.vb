...
Public Class ActualizarMarcacionTipoSIMserialesCEM
...
#Region "Eventos"
        ...
        Try
            ...
            If Not IsPostBack Or Not IsCallback Then
                With miEncabezado
                    ...
                    .setTitle("Actualizar Marcación Tipo Sims serial CEM")
                End With
            End If
    ...
    Protected Sub ButtonVerEjemplo_Click(sender As Object, e As EventArgs) Handles ButtonVerEjemplo.Click
        Try
            Dim filename As String = Server.MapPath("~/MensajeriaEspecializada/Plantillas/PlantillaCambioMarcacionSerialesTipoSims.xlsx")
            If filename <> "" Then
...
#Region "Métodos Privados"
            ...
            If upArchivo.HasFile Then
                ...
                If numColumnas = 3 Then
                    ...
                    If Session("dtResultado") Is Nothing Then
                        ...
                        Dim cargueRadicado As New ActualizarMarcacionTipoSIMCARDserialesCEMC()
                        Session("dtResultado") = cargueRadicado.AcualizarTipoSims(dtUsuarioEjecutor, idUsuario, resultado)
                        If (resultado = 0) Then
                            With gvErrores
                                .DataSource = CType(Session("dtResultado"), DataTable)
                                .DataBind()
    ...
    Private Function CrearEstructuraDeTabla() As DataTable
        ...
        With dtAux.Columns
            ...
            dtAux.Columns.Add(New DataColumn("Sims", GetType(String)))
            dtAux.Columns.Add(New DataColumn("TipoSim", GetType(String)))
        End With
        Return dtAux
    End Function
