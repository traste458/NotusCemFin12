...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            With epNotificacion
                .setTitle("Creación Ordenes Recolección Seriales")
...
#Region "Métodos Privados"
    ...
    Private Function CargarPool() As DataSet
        ...
        Try
            ...
            Dim dtDatos As DataTable = objGenerarPoolRutas.GenerarPoolRecoleccionServicioTecnico()

            dsDatos.Tables.Add(dtDatos.DefaultView.ToTable(True, "idServicioMensajeria", "numeroRadicado", _
                                                            "nombre", "identificacion", "nombreAutorizado", _
                                                            "direccion", "telefono", "fechaAgenda", "urgente"))
    ...
    Private Function ValidaSeleccionDatos() As ResultadoProceso
        ...
        Try
            ...
            _dtServicios.Columns.Add(New DataColumn("idDetalleSerial", Type.GetType("System.String")))
    ...
    Private Sub GenerarOrden()
        ...
        Try
            ...
            With objRutaServicio
                ...
                .TipoRuta = Enumerados.TipoRutaServicioMensajeria.RecoleccionProveedorServicioTecnico
