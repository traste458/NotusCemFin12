<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RegistrarServicioTipoVentaEDUCLIC.aspx.vb"
    Inherits="BPColSysOP.RegistrarServicioTipoVentaEDUCLIC" %>
...
<head runat="server">
    <title>Registro Servicio Tipo Venta EDUCLIC</title>
...
<body class="cuerpo2">
    ...
    <dx:ASPxCallback ID="cbPrincipal" runat="server" ClientInstanceName="Callback">
        <ClientSideEvents CallbackComplete="function(s, e) { 
            ...
            if (s.cpValorARecaudar){
                var objValorRecaudo = ASPxClientControl.GetControlCollection().GetByName('lblValorARecaudar');
                objValorRecaudo.SetText(s.cpValorARecaudar);
            }
            ...
            <dx:PanelContent>
                <table cellpadding="1">
                    <tr>
                            ...
                            <dx:ASPxComboBox ID="cmbCiudadEntrega" runat="server" ValueType="System.Int32" IncrementalFilteringMode="Contains"
                                ...
                                <ClientSideEvents SelectedIndexChanged="function(s, e) {
                                            if(cmbCiudadEntrega.GetValue()!=null) {
                                                LoadingPanel.Show();
                                                cmbEstablecimientos.PerformCallback();
                                            } else {
                                                alert(&#39;Se debe seleccionar una Ciudad de Entrega antes de seleccionar una establecimiento&#39;);
                                                cmbEstablecimientos.SetText(null);
                        ...
                        <td>
                            <dx:ASPxComboBox ID="cmbEstablecimientos" runat="server" ValueType="System.Int32" IncrementalFilteringMode="Contains"
                                Width="250px" ClientInstanceName="cmbEstablecimientos">
                                <ValidationSettings CausesValidation="True" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip"
                                    ValidationGroup="vgRegistrar">
                                    <RequiredField IsRequired="True" ErrorText="El Establecimiento es requerido"></RequiredField>
                                </ValidationSettings>
                        ...
                        <td>
                            <div style="float: left; margin-right: 0px;">
                                <dx:ASPxComboBox ID="cmbEquipo" runat="server" ValueType="System.String" DropDownWidth="600"
                                    ...
                                    Style="display: inline" ClientInstanceName="cmbEquipo">
                                    <ValidationSettings CausesValidation="True" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip"
                                        ValidationGroup="vgRegistrar">
                            ...
                            <div style="float: left; margin-right: 0px;">
                                <dx:ASPxCheckBox ID="cbRequerido" runat="server" Checked="true" Text="Requerido"
                                    Style="display: inline;" Theme="Aqua">
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxComboBox ID="cmbTipoCliente" runat="server" ValueType="System.Int32" ClientInstanceName="cmbTipoCliente">
                                <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ValidationGroup="vgRegistrar">
                                    <RequiredField ErrorText="El tipo de Cliente es requerido" IsRequired="True" />
                                </ValidationSettings>
                            <ClientSideEvents EndCallback="function(s, e) {
                                                var objValorRecaudo = ASPxClientControl.GetControlCollection().GetByName('lblValorARecaudar');
                                                objValorRecaudo.SetText(s.cpValorARecaudar);
                                                ...
                                                if(cmbTipoCliente.GetValue() != null && cmbPlan.GetValue() != null && cmbEquipo.GetValue() != null){
                                                    Callback.PerformCallback('CalcularValorARecaudar');
                                                    LoadingPanel.Show();
                                                } else {
                                                    alert('Debe seleccionar un plan, el equipo y un tipo de cliente.');
                                                    s.SetSelectedIndex(-1);
                                                }
                                            }">
                                    </ClientSideEvents>
                        ...
                        <td colspan="2">
                            <dx:ASPxLabel ID="lblValorARecaudar" runat="server" Font-Bold="False" ClientInstanceName="lblValorARecaudar"
                                Font-Italic="True" Font-Overline="False" Font-Strikeout="False" Width="100%"
                                ForeColor="#6600CC" Theme="Aqua">
                            </dx:ASPxLabel>&nbsp;
                        </td>
                    ...
                    <tr>
                        <td >
                            Tipo Identificación del(a) Niño(a):
                        </td>
                        <td>
                            <dx:ASPxComboBox ID="cmbTipoIdentificacionNino" runat="server" ValueType="System.Int32" IncrementalFilteringMode="Contains">
                                <ValidationSettings CausesValidation="True" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip"
                                    ValidationGroup="vgRegistrar">
                                    <RequiredField IsRequired="True" ErrorText="El Tipo de Identificacion es requerido"></RequiredField>
                                </ValidationSettings>
                            </dx:ASPxComboBox>&nbsp;
                        </td>
                        <td>
                            Identificación del(a) Niño(a):
                        </td>
                        <td>
                            <dx:ASPxTextBox ID="txtIdentificacionNino" runat="server" Width="170px" NullText="Número de Identificación..."
                                onkeypress="javascript:return ValidaNumero(event);" MaxLength="15">
                                <ValidationSettings ErrorText="Valor incorrecto" CausesValidation="True" Display="Dynamic"
                                    ErrorDisplayMode="ImageWithTooltip" ValidationGroup="vgRegistrar">
                                    <RequiredField IsRequired="True" ErrorText="La identificaci&#243;n es requerida"></RequiredField>
