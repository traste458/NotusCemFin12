<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReporteInventarioSiembra.aspx.vb"
    Inherits="BPColSysOP.ReporteInventarioSiembra" %>
...
<head runat="server">
    <title>.:: Reporte de Inventario SIEMBRA ::.</title>
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="2">
                                            <dx:ASPxComboBox ID="cmbCiudad" runat="server" DropDownStyle="DropDownList"
                                                ...
                                                <Columns>
                                                    <dx:ListBoxColumn FieldName="ciudad" Caption="Ciudad" Width="200px" />
                                                    <dx:ListBoxColumn FieldName="departamento" Caption="Departamento" Width="200px" />
                                                </Columns>
                                            </dx:ASPxComboBox>
                                        </td>
                                    </tr>
                ...
                <dx:PanelContent>
                    <dx:ASPxGridView ID="gvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="Descripcion" Caption="Descripción de Producto" ShowInCustomizationForm="True"
                                VisibleIndex="1">
                            </dx:GridViewDataTextColumn>
                            ...
                            <dx:GridViewDataTextColumn FieldName="Bodega" Caption="Bodega"
                                ShowInCustomizationForm="True" VisibleIndex="5">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="Ciudad" Caption="Ciudad" ShowInCustomizationForm="True"
                                VisibleIndex="6">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="Departamento" Caption="Departamento" ShowInCustomizationForm="True"
                                VisibleIndex="7">
                            </dx:GridViewDataTextColumn>
                        </Columns>
