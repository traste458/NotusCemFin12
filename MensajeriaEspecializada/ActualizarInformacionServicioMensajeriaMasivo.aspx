<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ActualizarInformacionServicioMensajeriaMasivo.aspx.vb"
    Inherits="BPColSysOP.ActualizarInformacionServicioMensajeriaMasivo" %>
...
<head runat="server">
    <title>Registrar Novedades Servicio</title>
        ...
        <div>
            ...
            <div style="float: left; margin-right: 20px; margin-bottom: 20px; margin-top: 15px; width: 100%;">
                ...
                LoadingPanel.Hide(); }"></ClientSideEvents>
                    <PanelCollection>
                        <dx:PanelContent>
                            <dx:ASPxRoundPanel ID="rpCambioTipoSim" runat="server" HeaderText="Registrar Novedades Servicio"
                                Width="60%">
                                <PanelCollection>
                                    <dx:PanelContent>
                                                ...
                                                <dx:LayoutGroup Caption="&nbsp;" ColCount="3" GroupBoxDecoration="None" SettingsItemCaptions-HorizontalAlign="Right">
                                                    <Items>
                                                        ...
                                                        <dx:LayoutItem Caption="&nbsp;" ColSpan="3">
                                                            <LayoutItemNestedControlCollection>
                                                                <dx:LayoutItemNestedControlContainer>
                                                                    <dx:ASPxComboBox ID="cmbTipoCambio" runat="server" ClientInstanceName="cmbTipoCambio" NullText="Seleccione ..." Width="450px"
                                                                        SelectedIndex="0"  DropDownStyle="DropDownList" TextFormatString="{0}" EnableCallbackMode="true" 
                                                                        IncrementalFilteringMode="StartsWith" ValueField="IdCampo" ValueType="System.Int32" DataSourceID="OdsTipoModificacion">
                                                                        <Columns>
                                                                            <dx:ListBoxColumn FieldName="id" Caption="IdCampo" Width="15px" Visible="false" />
                                                                            <dx:ListBoxColumn FieldName="Observacion" Caption="Observacion" Width="200px" />
                                                                            <dx:ListBoxColumn FieldName="CamposRequeridos" Caption="CamposRequeridos" Width="300px" />
                                                                        </Columns>
                                                                        <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ValidationGroup="validacion">
                                                                            <RequiredField ErrorText="Información Requerida" IsRequired="true" />
                                                                        </ValidationSettings>
                                                                    </dx:ASPxComboBox>
                                                                    <asp:ObjectDataSource ID="OdsTipoModificacion" runat="server" SelectMethod="ConsultaCamposActualizarServicioMensajeria" TypeName="ILSBusinessLayer.MensajeriaEspecializada.HerramientasMensajeria"></asp:ObjectDataSource>
                                                                    <br />
                                                                    <br />
                                                                </dx:LayoutItemNestedControlContainer>
                                                            </LayoutItemNestedControlCollection>
                                                            ...
                                                            <LayoutItemNestedControlCollection>
                                                                <dx:LayoutItemNestedControlContainer>
                                                                    <dx:ASPxButton ID="btnUpload" AutoPostBack="false" runat="server" ValidationGroup="validacion" ClientInstanceName="btnUpload" CssClass="submit"
                                                                        ...
                                                                        <ClientSideEvents Click="function (s, e){   if(ASPxClientEdit.ValidateGroup('validacion')){
                                                                            ValidarArchivoTipo(); setTimeout ('LoadingPanel.Hide();', 8000); }}
                                                                            " />
