<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CreacionOrdenRecoleccionServicio.aspx.vb" Inherits="BPColSysOP.CreacionOrdenRecoleccionServicio" %>
...
<head runat="server">
    <title>Creación Rutas Recolección Seriales - Mensajería Especializada</title>
                        ...
                        <td align="center" colspan="2">
                            <div style="margin-top:15px">
                                ...
                                <asp:LinkButton ID="lbGenerarRuta" runat="server" CssClass="search" Font-Bold="True" CausesValidation="true" ValidationGroup="vgDespacho"
                                    OnClientClick="return confirm('¿Está seguro que desea crear la orden de recolección para los IMEIS seleccionados?')">
                                            <img alt="Generar Orden" src="../images/trans_small.png" />&nbsp;Generar Orden
                                </asp:LinkButton>
                            </div>
                        </td>
                    </tr>
                                        ...
                                        <asp:Panel ID="pnlDetalle" runat="server" Style="display: none;" Width="100%">
                                            <asp:GridView ID="gvDatosDetalle" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:CheckBoxField DataField="generaCosto" HeaderText="Genera Costo" ItemStyle-HorizontalAlign="Center" />
                                                    <asp:CheckBoxField DataField="clienteAceptaCosto" HeaderText="Cliente acepta costo" ItemStyle-HorizontalAlign="Center" />
                                                    <asp:BoundField DataField="fechaEntregaServicioTecnico" HeaderText="Fecha Entrega" DataFormatString="{0:dd/MM/yyyy}" />
                                                </Columns>
