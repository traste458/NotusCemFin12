<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RegistrarServicioTipoSiembra.aspx.vb"
    Inherits="BPColSysOP.RegistrarServicioTipoSiembraNew1" %>
                                        ...
                                        <dx:LayoutItem Caption="Dirección:">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer123" runat="server">
                                                    <as:AddressSelector ID="memoDireccion1" runat="server" />
                                                    <asp:RequiredFieldValidator ID="rfvasDireccion1" runat="server" ControlToValidate="memoDireccion1"
