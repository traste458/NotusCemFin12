<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RealizarCambiosDeEstadoMasivosServicioMensajeria.aspx.vb"
    Inherits="BPColSysOP.RealizarCambiosDeEstadoMasivosServicioMensajeria" %>
        ...
        <div>
            ...
            <div style="float: left; margin-right: 20px; margin-bottom: 20px; margin-top: 15px; width: 100%;">
                ...
                LoadingPanel.Hide(); }"></ClientSideEvents>
                    <PanelCollection>
                        <dx:PanelContent>
                            <dx:ASPxRoundPanel ID="rpCambioTipoSim" runat="server" HeaderText="Cambios de Estado Masivos Servicio Mensajería"
                                Width="60%">
                                <PanelCollection>
                                    <dx:PanelContent>
