...
Public Class CreacionRutasServicioTipoVenta
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            With epNotificacion
                .setTitle("Creación de Rutas - Ventas Telefónicas")
...
#Region "Métodos"
    ...
    Private Sub GenerarRutas()
        ...
        Try
            ...
            Dim dvResponsables As DataView = _dtServicios.DefaultView
            dvResponsables.RowFilter = "idResponsableEntrega = '&nbsp;'"

            If dvResponsables.Count = 0 Then
                dvResponsables.RowFilter = ""
                ...
                For Each responsable As DataRow In dtResponsables.Rows
                    ...
                    objRutaServicio.TipoRuta = Enumerados.TipoRutaServicioMensajeria.EntregaCliente
            ...
            Else
                epNotificacion.showWarning("Algunos registros no cumplen los requerimientos para crear la ruta, verifique que todos posean usuario de entrega asignado.")
            End If
        Catch ex As Exception
...
#Region "Funciones"
    ...
    Private Function CargarPool() As DataTable
        ...
        Try
            ...
            dtPool = objGenerarPoolRutas.GenerarPoolEntregaVentas()
        Catch ex As Exception
