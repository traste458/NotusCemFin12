<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CrearCargueRealceBancolombia.aspx.vb" Inherits="BPColSysOP.CrearCargueRealceBancolombia" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function VerEjemplo() {
            window.location.href = 'Archivos/PlantillaRealcesBancolombia.xlsx';
        }
