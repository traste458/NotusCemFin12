<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PoolEliminarVisitasSimpliRoute.aspx.vb" Inherits="BPColSysOP.PoolEliminarVisitasSimpliRoute" %>
...
<head runat="server">
    ...
    <script>
        ...
        function ObtieneValoresServicioCallback() {
            ...
            //}
            gvDatos.PerformCallback("1" + '|EliminarVisitas');
        }
                            ...
                            <PanelCollection>
                                <dx:PanelContent>
                                    ...
                                    <dx:ASPxGridView ID="gvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ClientInstanceName="gvDatos" KeyFieldName="idVisita">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn FieldName="idVisita" Caption="IdVisita" ShowInCustomizationForm="True" VisibleIndex="1">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="idServicioMensajeria" Caption="Id." ShowInCustomizationForm="True" VisibleIndex="2">
                                            </dx:GridViewDataTextColumn>
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="direccion" Caption="Direccion Visita" ShowInCustomizationForm="True" VisibleIndex="4">
                                            </dx:GridViewDataTextColumn>
                                            ...
                                            <dx:GridViewCommandColumn ShowSelectCheckbox="True" VisibleIndex="0">
                                                <HeaderTemplate>
                                                    ...
                                                    <dx:ASPxButton ID="btnEleminarVisitas" runat="server" Text="Eliminar Visitas"
                                                        ToolTip="Eliminar Visitas para Servicios seleccionados" AutoPostBack="false">
                                                        <ClientSideEvents Click="function(s, e) {
                                                                if(gvDatos.GetSelectedRowCount() &gt; 0){
                                                                    if(confirm('¿Realmente desea eliminar visitas para los [' + gvDatos.GetSelectedRowCount() + '] servicios seleccionados?')) {
                                                                        grid_SeleccionServiciosVisita();
                                                                    }
                                                                } else { alert('Debe seleccionar por lo menos un servicio para eliminar visita.'); }
                                                            }" />
                                                                                    ...
                                                                                    <Templates>
                                                                                        <StatusBar>
                                                                                            <table style="float: right">
                                                                                                <tr>
                                                                                                    <td onclick="return _aspxCancelBubble(event)">
                                                                                                        <dx:ASPxButton ID="ASPxButton1" runat="server" AutoPostBack="false" Text="Close" ClientSideEvents-Click="CloseGridLookupTipoServicio" />
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </StatusBar>
