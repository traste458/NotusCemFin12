<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RegistraGestionCasoSAC.aspx.vb"
    Inherits="BPColSysOP.RegistraGestionCasoSAC" %>
...
<body class="cuerpo2">
    ...
    <asp:Panel ID="pnlDatosCaso" runat="server">
        <table style="width: 90%;" class="tabla" border="1" bordercolor="#f0f0f0" cellspacing="1"
            ...
            <tr id="trCerrarCaso" runat="server">
