...
<%
sqlCac = "select idcac, idcac2, cac from cac where idcac = ( select idcac from terceros where idtercero =  " & session("usxp001") & ")"
...
<a href="javascript:history.back();"><font color="blue">Regresar</font></a> <br><br>
<%
...
sqlInventario = sqlInventario & " (select subproducto from subproductos where idsubproducto = a.idsubproducto) as subproducto, "
