...
<%
  ...
  while not rs.eof
    ...
    %>
    <TR bgcolor="<%=bgcolor%>">
      <TD align="right"><font size=1><%=idorden%></font></TD>
      <TD align="left"><font size=1><%=idorden2%></font></TD>
      <TD align="center"><font size=1><%=fecha%></font></TD>
      <TD align="left"><font size=1><%=cac%></font></TD>
      <TD align="right"><font size=1><%=cantidad%></font></TD>
      <TD align="right"><font size=1><%=cantidad_leida%></font></TD>
      <TD align="left"><font size=1><%=subproducto%></font></TD>
      <TD align="left"><font size=1><%=estado%></font></TD>
    </TR>
<% 
