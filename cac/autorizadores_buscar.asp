...
<BODY class="cuerpo2">
<% session("titulo") = "<b>Buscar Autorizadores </b>" %>
<!--#include file="../include/titulo1.inc.asp"-->
<!--#include file="../include/conexion.inc.asp"-->
<A HREF="javascript: history.back();"><u>Regresar</u></A>
<BR><BR>
<FORM NAME="forma" METHOD="POST" ACTION="autorizadores_buscar2.asp" onsubmit="return validacion();">
<UL>
...
<TABLE class="tabla">
  <TR>
    ...
    <TD><INPUT TYPE="TEXT" NAME="cedula" SIZE="15" MAXLENGTH="12" class="textbox"></TD>
  </TR>  
  <TR>
    <TD BGCOLOR="#F0F0F0"><B>Nombre Autorizador: **</B></TD>
    <TD><INPUT TYPE="TEXT" NAME="autorizador" SIZE="40" MAXLENGTH="80" class="textbox"></TD>
  </TR>  
  <TR>
