<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CirculoAzulReporte.aspx.vb" 
Inherits="BPColSysOP.CirculoAzulReporte" %>
...
<head id="Head1" runat="server">
    <title>Circulo Azul Reporte</title>
        ...
        <asp:Panel ID="pnlFiltros" runat="server">
            <table class="tablaGris" style="width: auto;">
                ...
                <tr>
                    ...
                    <td style="vertical-align: middle" nowrap="nowrap" colspan ="4">
        ...
        <asp:Panel ID="panelResultado" runat="server">
            <asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="cliente" HeaderText="Empresa" ItemStyle-HorizontalAlign="left" />
                        <asp:BoundField DataField="msisdn" HeaderText="Msisdn" />
                        <asp:BoundField DataField="identificacion" HeaderText="NIT"/>
