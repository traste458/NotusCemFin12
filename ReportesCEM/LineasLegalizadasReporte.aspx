<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LineasLegalizadasReporte.aspx.vb"
    Inherits="BPColSysOP.LineasLegalizadasReporte" %>
...
<head runat="server">
    <title>Lineas Legalizadas</title>
...
<body class="cuerpo2">
    ...
    <eo:CallbackPanel ID="cpNotificacion" runat="server" UpdateMode="Always" Width="100%">
        ...
        <uc1:EncabezadoPagina ID="epReporteLegalizados" runat="server" />
    </eo:CallbackPanel>
        ...
        <asp:Panel ID="pnlFiltros" runat="server">
            <table class="tablaGris" style="width: auto;">
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtPlanilla" runat="server" MaxLength="17">
                        </asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="vertical-align: middle" nowrap="nowrap">
                        ...
                        <div style="clear: both">
                        <asp:CustomValidator ID="cusSeleccion" runat="server" ErrorMessage="La fecha de entrega es obligatroria"
                    ...
                    <td>
                        <asp:DropDownList ID="ddlTipoLegalizacion" runat="server">
                        <asp:ListItem Value="-1" Text="Seleccione una Opci&oacute;n"></asp:ListItem>
                            <asp:ListItem Value="0" Text="Logytech Mobile"></asp:ListItem>
                            <asp:ListItem Value="1" Text="Comcel"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td class="field">
                        Tipo de Novedad:
                    ...
                    <td style="vertical-align: middle" nowrap="nowrap">
                        <table style="padding: 0px !important">
                            <tr>
                                ...
                                <td valign="middle">
                                    <input class="textbox" id="txtFechaInicialLegaliza" readonly="readonly" size="11" name="txtFechaInicialLegaliza"
                                        runat="server" />
                                </td>
                                <td valign="middle">
                                    <a hidefocus onclick="if(self.gfPop)gfPop.fStartPop(document.form1.txtFechaInicialLegaliza,document.form1.txtFechaFinalLegaliza);return false;"
                                        href="javascript:void(0)">
                                        <img class="PopcalTrigger" height="22" alt="Seleccione una Fecha Inicial" src="../include/DateRange/calbtn.gif"
                                            width="34" align="middle" border="0"></a>
                                </td>
                                ...
                                <td>
                                    <input class="textbox" id="txtFechaFinalLegaliza" readonly="readonly" size="11" name="txtFechaFinalLegaliza"
                                        runat="server" />
                                </td>
                                <td>
                                    <a hidefocus onclick="if(self.gfPop)gfPop.fEndPop(document.form1.txtFechaInicialLegaliza,document.form1.txtFechaFinalLegaliza);return false;"
                                        href="javascript:void(0)">
                                        <img class="PopcalTrigger" height="22" alt="Seleccione una Fecha Final" src="../include/DateRange/calbtn.gif"
                                            width="34" align="middle" border="0"></a>
                                </td>
                    ...
                    <td style="vertical-align: middle" nowrap="nowrap">
                        <table style="padding: 0px !important">
                            <tr>
                                ...
                                <td valign="middle">
                                    <input class="textbox" id="txtFechaInicialAsignacion" readonly="readonly" size="11" name="txtFechaInicialAsignacion"
                                        runat="server" />
                                </td>
                                <td valign="middle">
                                ...
                                <td>
                                    <input class="textbox" id="txtFechaFinalAsignacion" readonly="readonly" size="11" name="txtFechaFinalAsignacion"
                                        runat="server" />
                                </td>
                                <td>
        ...
        <asp:Panel ID="panelResultado" runat="server">
            <asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="serial" HeaderText="Imei" ItemStyle-HorizontalAlign="Right" />
                        <asp:BoundField DataField="msisdn" HeaderText="Msisdn" />
                        <asp:BoundField DataField="ciudad" HeaderText="Ciudad" />
                        <asp:BoundField DataField="responsableEntrega" HeaderText="Responsable" />
                        <asp:BoundField DataField="planillaLegalizacion" HeaderText="Número de planilla" />
                        <asp:BoundField DataField="fechaLegalizacion" HeaderText="Fecha de Legalización" />
                        <asp:BoundField DataField="horaLegalizacion" HeaderText="Hora de Legalización"/>
                        ...
                        <asp:BoundField DataField="responsableLegalizacion" HeaderText="Responsable de la legalización"/>
                    </Columns>
