<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SalidaRutaMotorizadoReporte.aspx.vb" 
Inherits="BPColSysOP.SalidaRutaMotorizadoReporte" %>
...
<head id="Head1" runat="server">
    <title>Salida Ruta Motorizado</title>
        ...
        <asp:Panel ID="pnlFiltros" runat="server">
            <table class="tablaGris" style="width: auto;">
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtRadicado" runat="server" MaxLength="20">
                        </asp:TextBox>
                        <div style="clear: both">
                            <asp:RegularExpressionValidator ID="revRadicado" runat="server" Display="Dynamic"
                                ...
                                ValidationExpression="[0-9]{2,20}"></asp:RegularExpressionValidator>
                        </div>
                    </td>
                    <td class="field" align="left">
                        MSISDN:
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:DropDownList ID="ddlJornada" runat="server">
                            <asp:ListItem Value="0">Seleccione una Jornada</asp:ListItem>
        ...
        <asp:Panel ID="panelResultado" runat="server">
            <asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="serial" HeaderText="Imei - Iccid" />
                        <asp:BoundField DataField="msisdn" HeaderText="Msisdn" />
                        <asp:BoundField DataField="ciudad" HeaderText="Ciudad" />
                        <asp:BoundField DataField="agente" HeaderText="Agente Servicio"/>
                        <asp:BoundField DataField="estado" HeaderText="Estado"/>
                        <asp:BoundField DataField="observacionEspecifica" HeaderText="Observación Especifica"/>
                        <asp:BoundField DataField="tipo" HeaderText="Tipo"/>
                        <asp:BoundField DataField="idRuta" HeaderText="Ruta" />
                        <asp:BoundField DataField="EtadoRuta" HeaderText="Etado Ruta" />
