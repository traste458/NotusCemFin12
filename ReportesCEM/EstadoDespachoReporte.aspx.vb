...
Partial Public Class EstadoDespachoReporte
...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            Try
                With epNotificacion
                    .setTitle("Reporte Estado Despachos")
...
#Region "Métodos Privados"
    ...
    Private Function ConsultarReporte() As DataTable
        Dim reporte As New EstadoDespachos
        Dim dtDatos As DataTable
        ...
        With reporte
            ...
            If Not String.IsNullOrEmpty(txtFechaInicialDespacho.Value) Then .FechaInicialDespacho = CDate(txtFechaInicialDespacho.Value)
            If Not String.IsNullOrEmpty(txtFechaFinalDespacho.Value) Then .FechaFinalDespacho = CDate(txtFechaFinalDespacho.Value)
    ...
    Private Sub LimpiarControles()
        ...
        txtFechaFinalDespacho.Value = ""
        txtFechaInicialDespacho.Value = ""
    ...
    Private Function GenerarArchivoExcel(ByVal dtDatos As DataTable) As String
        Dim rutaPlantilla As String = Server.MapPath("~/ReportesCEM/Plantillas/PlantillaReporteEstadoDespacho.xlsx")
        Dim nombreArchivo As String = Server.MapPath("~/archivos_planos/ReporteEstadoDespacho" & Session("usxp001") & ".xls")
        ...
        Else
            miHoja = miExcel.Worksheets.Add("Reporte Estado Despachos")
