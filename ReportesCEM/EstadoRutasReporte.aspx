<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EstadoRutasReporte.aspx.vb" 
Inherits="BPColSysOP.EstadoRutasReporte" %>
        ...
        <asp:Panel ID="panelResultado" runat="server">
            <asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="jornada" HeaderText="Jornanda" />
                        <asp:BoundField DataField="cliente" HeaderText="Cliente"/>
                        <asp:BoundField DataField="identificacion" HeaderText="CC/Nit" />
