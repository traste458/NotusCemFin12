...
#Region "Eventos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            Try
                With epNotificacion
                    .setTitle("Reporte Salida Ruta Motorizado")
...
#Region "Métodos Privados"
    ...
    Private Function ConsultarReporte() As DataTable
        Dim reporte As New SalidaRutaMotorizados
        Dim dtDatos As DataTable
    ...
    Private Function GenerarArchivoExcel(ByVal dtDatos As DataTable) As String
        Dim rutaPlantilla As String = Server.MapPath("~/ReportesCEM/Plantillas/PlantillaSalidaRutaMotorizado.xlsx")
        Dim nombreArchivo As String = Server.MapPath("~/archivos_planos/ReporteSalidaRutaMotorizado" & Session("usxp001") & ".xls")
        ...
        Else
            miHoja = miExcel.Worksheets.Add("Reporte Salida Ruta Motorizado")
