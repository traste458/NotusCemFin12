<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SimCardReporte.aspx.vb" 
Inherits="BPColSysOP.SimCardReporte" %>
        ...
        <asp:Panel ID="pnlFiltros" runat="server">
            <table class="tablaGris" style="width: auto;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlTipoSim" runat="server">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
        ...
        <asp:Panel ID="panelResultado" runat="server">
            <asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="iccid" HeaderText="SimCard Entregada"/>
