...
Partial Public Class CirculoAzulReporte
...
#Region "Métodos Privados"
    ...
    Private Function ConsultarReporte() As DataTable
        Dim reporte As New CirculoAzul
        Dim dtDatos As DataTable
    ...
    Private Function GenerarArchivoExcel(ByVal dtDatos As DataTable) As String
        Dim rutaPlantilla As String = Server.MapPath("~/ReportesCEM/Plantillas/PlantillaReporteCirculoAzul.xlsx")
        Dim nombreArchivo As String = Server.MapPath("~/archivos_planos/ReporteCirculoAzul" & Session("usxp001") & ".xls")
        ...
        Else
            miHoja = miExcel.Worksheets.Add("Reporte Circulo Azul")
