...
Partial Public Class EstadoRutasReporte
...
#Region "Métodos Privados"
    ...
    Private Function ConsultarReporte() As DataTable
        Dim reporte As New EstadoRutas
        Dim dtDatos As DataTable
    ...
    Private Function GenerarArchivoExcel(ByVal dtDatos As DataTable) As String
        Dim rutaPlantilla As String = Server.MapPath("~/ReportesCEM/Plantillas/PlantillaEstadoRutas.xlsx")
        Dim nombreArchivo As String = Server.MapPath("~/archivos_planos/ReporteEstadoRutas" & Session("usxp001") & ".xls")
        ...
        Else
            miHoja = miExcel.Worksheets.Add("Reporte Estado Rutas")
