<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EstadoDespachoReporte.aspx.vb"
    Inherits="BPColSysOP.EstadoDespachoReporte" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function esRangoValido(source, arguments) {
            try {
                if (document.getElementById("txtFechaInicialDespacho").value.trim() != "" || document.getElementById("txtFechaFinalDespacho").value.trim() != "") {
                    if (document.getElementById("txtFechaInicialDespacho").value.trim() != "" && document.getElementById("txtFechaFinalDespacho").value.trim() == "") {
...
<body class="cuerpo2">
            ...
            <table class="tablaGris" style="width: auto;">
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <div style="clear: both">
                            <asp:RegularExpressionValidator ID="revMsisdn" runat="server" Display="Dynamic" ControlToValidate="txtMsisdn"
                                ValidationGroup="vgFiltro" ErrorMessage="El valor digitado no es valido" ValidationExpression="[0-9]{10}"></asp:RegularExpressionValidator>
                        </div>
                    </td>
                    <td class="field" align="left">
                        Serial:
                    ...
                    <td align="left">
                        ...
                        <div style="clear: both">
                            <asp:RegularExpressionValidator ID="revSerial" runat="server" Display="Dynamic" ControlToValidate="txtSerial"
                                ValidationGroup="vgFiltro" ErrorMessage="El valor digitado no es valido" ValidationExpression="[0-9]{15,17}"></asp:RegularExpressionValidator>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="vertical-align: middle" nowrap="nowrap">
                        <table style="padding: 0px !important">
                            <tr>
                                ...
                                <td valign="middle">
                                    <input class="textbox" id="txtFechaInicialDespacho" readonly="readonly" size="11"
                                        name="txtFechaInicialDespacho" runat="server" />
                                </td>
                                <td valign="middle">
                                    <a hidefocus onclick="if(self.gfPop)gfPop.fStartPop(document.form1.txtFechaInicialDespacho,document.form1.txtFechaFinalDespacho);return false;"
                                        href="javascript:void(0)">
                                        <img class="PopcalTrigger" height="22" alt="Seleccione una Fecha Inicial" src="../include/DateRange/calbtn.gif"
                                            width="34" align="middle" border="0"></a>
                                </td>
                                ...
                                <td>
                                    <input class="textbox" id="txtFechaFinalDespacho" readonly="readonly" size="11" name="txtFechaDespacho"
                                        runat="server" />
                                </td>
                                <td>
                                    <a hidefocus onclick="if(self.gfPop)gfPop.fEndPop(document.form1.txtFechaInicialDespacho,document.form1.txtFechaFinalDespacho);return false;"
                                        href="javascript:void(0)">
                                        <img class="PopcalTrigger" height="22" alt="Seleccione una Fecha Final" src="../include/DateRange/calbtn.gif"
                                            width="34" align="middle" border="0"></a>
                                </td>
                        ...
                        <div style="clear: both">
                            <asp:CustomValidator ID="cusSeleccion" runat="server" ErrorMessage="La fecha de despacho es obligatroria"
                    ...
                    <td style="vertical-align: middle" nowrap="nowrap">
                        <table style="padding: 0px !important">
                            <tr>
                                ...
                                <td valign="middle">
                                    <input class="textbox" id="txtFechaInicialAsignacion" readonly="readonly" size="11"
                                        name="txtFechaInicialAsignacion" runat="server" />
                                </td>
                                <td valign="middle">
                                    <a hidefocus onclick="if(self.gfPop)gfPop.fStartPop(document.form1.txtFechaInicialAsignacion,document.form1.txtFechaFinalAsignacion);return false;"
                                        href="javascript:void(0)">
                                        <img class="PopcalTrigger" height="22" alt="Seleccione una Fecha Inicial" src="../include/DateRange/calbtn.gif"
                                            width="34" align="middle" border="0"></a>
                                </td>
                                ...
                                <td>
                                    <input class="textbox" id="txtFechaFinalAsignacion" readonly="readonly" size="11"
                                        name="txtFechaFinalAsignacion" runat="server" />
                                </td>
                                <td>
                                    <a hidefocus onclick="if(self.gfPop)gfPop.fEndPop(document.form1.txtFechaInicialAsignacion,document.form1.txtFechaFinalAsignacion);return false;"
                                        href="javascript:void(0)">
                                        <img class="PopcalTrigger" height="22" alt="Seleccione una Fecha Final" src="../include/DateRange/calbtn.gif"
                                            width="34" align="middle" border="0"></a>
                                </td>
    ...
    <eo:CallbackPanel ID="cpDatos" runat="server" Width="100%" UpdateMode="Group" GroupName="general"
        ...
        <asp:Panel ID="panelResultado" runat="server">
            <asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" CssClass="grid"
                ...
                <FooterStyle CssClass="footerChildDG" Font-Bold="False" Font-Italic="False" Font-Overline="False"
                    Font-Strikeout="False" Font-Underline="False"></FooterStyle>
                <RowStyle Font-Size="11px" />
                <Columns>
                    <asp:BoundField DataField="numeroRadicado" HeaderText="Número de radicado" Visible="true" />
                    <asp:BoundField DataField="materialIccid" HeaderText="Material Iccid" />
                    <asp:BoundField DataField="referenciaImei" HeaderText="Referencia Imei" />
                    <asp:BoundField DataField="materialImei" HeaderText="Material Imei" />
                    <asp:BoundField DataField="referenciaIccid" HeaderText="Referencia Iccid" />
                    <asp:BoundField DataField="imei" HeaderText="Imei" ItemStyle-HorizontalAlign="left" />
                    <asp:BoundField DataField="iccid" HeaderText="Iccid" ItemStyle-HorizontalAlign="left" />
                    <asp:BoundField DataField="msisdn" HeaderText="Msisdn" />
                    <asp:BoundField DataField="fechaCambioServicio" HeaderText="Fecha de Cambio de Servicio" />
                    <asp:BoundField DataField="horaCambioServicio" HeaderText="Hora de Cambio de Servicio" />
                    <asp:BoundField DataField="ciudad" HeaderText="Ciudad" />
                    <asp:BoundField DataField="despachadoPor" HeaderText="Despachado Por" />
