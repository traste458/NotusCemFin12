<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdministrarFabricante.aspx.vb"
    Inherits="BPColSysOP.AdministrarFabricante" %>
                            ...
                            <table class="tabla" border="1" align="center">
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        ...
                                        <asp:HiddenField ID="hIdFabricante" runat="server" />
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
            ...
            <table class="tabla">
                <tr>
                    <th style="text-align: center">
                        LISTADO DE FABRICANTE REGISTRADOS
                    </th>
                </tr>
                <tr>
                    <td>
                        <asp:GridView ID="gvFabricante" runat="server" EmptyDataText="<blockquote>No se encontraron registros</blockquote>"
                                ...
                                <asp:TemplateField HeaderText="OPCIÓN" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ibActualizar" ImageUrl="~/images/Edit-32.png" ToolTip="Actualizar"
                                            CommandName="actualizar" CommandArgument='<%# Bind("idFabricante") %>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
