<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CreaciondeClientes.aspx.vb"
    Inherits="BPColSysOP.CreaciondeClientes" %>
    ...
    <table class="tablaGris">
        ...
        <tr>
            <td colspan="4">
                <center>
                    <br />
                    <asp:Button ID="btnCliente" runat="server" Text="Crear" /></center>
            </td>
        </tr>
    </table>
    </form>
