...
Public Class PickingListBodega
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPColSysOP.PickingListBodega.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPickingListBodega
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PickingListBodega = New PickingListBodega
        rpt.Site = Me.Site
        Return rpt
    End Function
