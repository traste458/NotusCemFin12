...
Public Class FormatoOTBCuarentena
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FormatoOTBCuarentena.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPColSysOP.FormatoOTBCuarentena.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idOrdenBodegaje() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedFormatoOTBCuarentena
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FormatoOTBCuarentena = New FormatoOTBCuarentena
        rpt.Site = Me.Site
        Return rpt
    End Function
