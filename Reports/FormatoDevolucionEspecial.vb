...
Public Class FormatoDevolucionEspecial
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FormatoDevolucionEspecial.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPColSysOP.FormatoDevolucionEspecial.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idDetalle() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedFormatoDevolucionEspecial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FormatoDevolucionEspecial = New FormatoDevolucionEspecial()
        rpt.Site = Me.Site
        Return rpt
    End Function
