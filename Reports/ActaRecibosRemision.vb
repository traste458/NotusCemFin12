...
Public Class ActaRecibosRemision
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ActaRecibosRemision.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPColSysOP.ActaRecibosRemision.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedActaRecibosRemision
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ActaRecibosRemision = New ActaRecibosRemision()
        rpt.Site = Me.Site
        Return rpt
    End Function
