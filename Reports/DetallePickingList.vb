...
Public Class DetallePickingList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPColSysOP.DetallePickingList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDetallePickingList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DetallePickingList = New DetallePickingList
        rpt.Site = Me.Site
        Return rpt
    End Function
