...
Public Class GuiaTransportadora
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPColSysOP.GuiaTransportadora.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGuiaTransportadora
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GuiaTransportadora = New GuiaTransportadora
        rpt.Site = Me.Site
        Return rpt
    End Function
