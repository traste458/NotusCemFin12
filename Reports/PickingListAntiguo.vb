...
Public Class PickingListAntiguo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPColSysOP.PickingListAntiguo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPickingListAntiguo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PickingListAntiguo = New PickingListAntiguo
        rpt.Site = Me.Site
        Return rpt
    End Function
