...
Public Class RemisionDespachoEspecial
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RemisionDespachoEspecial.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPColSysOP.RemisionDespachoEspecial.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idDespacho() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRemisionDespachoEspecial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RemisionDespachoEspecial = New RemisionDespachoEspecial()
        rpt.Site = Me.Site
        Return rpt
    End Function
