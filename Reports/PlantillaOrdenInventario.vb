...
Public Class PlantillaOrdenInventario
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PlantillaOrdenInventario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPColSysOP.PlantillaOrdenInventario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idOrdenInventario() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPlantillaOrdenInventario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PlantillaOrdenInventario = New PlantillaOrdenInventario
        rpt.Site = Me.Site
        Return rpt
    End Function
