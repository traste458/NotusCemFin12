...
Public Class FormatoDevolucionNormal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FormatoDevolucionNormal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPColSysOP.FormatoDevolucionNormal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idorden() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedFormatoDevolucionNormal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FormatoDevolucionNormal = New FormatoDevolucionNormal
        rpt.Site = Me.Site
        Return rpt
    End Function
